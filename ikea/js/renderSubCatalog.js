...
const renderSubCatalog = () => {
  ...
  document.body.insertAdjacentElement("afterbegin", subCatalog);
  return updateHTML;
};
export default renderSubCatalog;
